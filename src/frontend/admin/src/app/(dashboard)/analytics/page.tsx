...
import AdminAnalytics from '@/components/views/admin/AdminAnalytics';
import TenantAnalytics from '@/components/views/tenant/TenantAnalytics';
...
export default function AnalyticsPage() {
  ...
  if (role === 'tenant') return <TenantAnalytics />;
