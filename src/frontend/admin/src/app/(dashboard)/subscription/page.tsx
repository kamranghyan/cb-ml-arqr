...
import AdminSubscription from '@/components/views/admin/AdminSubscription';
import TenantSubscription from '@/components/views/tenant/TenantSubscription';
...
export default function SubscriptionPage() {
  ...
  if (role === 'admin')  return <AdminSubscription />;
  if (role === 'tenant') return <TenantSubscription />;
