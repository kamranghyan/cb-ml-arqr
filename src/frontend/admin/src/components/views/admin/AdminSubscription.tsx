...
export default function AdminSubscription() {
    ...
    // IMPORTANT:
    // Only ONE declaration of colors / accents.
    ...
    const handleCreate = async (
        ...
        try {
            ...
            setSuccess(
                `Plan "${formData.plan_name}" created successfully!`
            );
    ...
    const handleUpdate = async (
        ...
        try {
            ...
            setSuccess(
                `Plan "${formData.plan_name}" updated successfully!`
            );
                    ...
                    style={{
                        ...
                        background:
                            accents
                                ...
                                .bg,
                        border:
                            `1px solid ${accents.green.border}`,
                        borderRadius: 10,
                        color:
                            accents
                                .green
