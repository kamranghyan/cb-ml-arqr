      ...
      {!loading && !error && (
        <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(300px,1fr))', gap: 16 }}>
            ...
            <Card title="By restaurant" href="/analytics" hrefLabel="See analytics">
              {perBranch.length === 0 ? (
            ...
            <Card title="Selling best" href="/analytics" hrefLabel="See analytics">
              {top.length === 0 ? (
            ...
            <Card title="Your restaurants" href="/restaurants" hrefLabel="Manage">
              {branches.length === 0 ? (
