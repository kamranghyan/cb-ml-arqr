...
if (typeof window !== 'undefined') {
  if (!RESTAURANT_ID) {
    console.warn('[API] NEXT_PUBLIC_RESTAURANT_ID is not set')
  }

  if (!TENANT_ID) {
    console.warn('[API] NEXT_PUBLIC_TENANT_ID is not set')
  }
}
...
// ─────────────────────────────────────────────────────────────
// MENU API
// All calls go through Next.js proxy: /api/menu
// ─────────────────────────────────────────────────────────────
...
export const MENU_API = {
  ...
  addons: (rid: string, itemId: string) =>
...
// ─────────────────────────────────────────────────────────────
// AR API
// All calls go through Next.js /api/ar proxy
// ─────────────────────────────────────────────────────────────
