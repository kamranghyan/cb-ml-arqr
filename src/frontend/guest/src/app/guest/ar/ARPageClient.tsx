  ...
  () => import('@/components/guest/ARViewer'),
  {
    ...
    loading: () => (
      <div style={{ width: '100%', height: 400, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12, background: '#F5F5F5', border: '1.5px solid #F0EBE6', borderRadius: 24 }}>
        ...
        <span style={{ fontSize: 13, color: '#6B6B6B', fontFamily: "'Poppins', sans-serif" }}>Loading AR viewer…</span>
      </div>
    ),
  },
);
        ...
        {error && !loading && (
          <div style={{ 
            ...
            <button 
              ...
              onFocus={(e) => {
                e.currentTarget.style.boxShadow = '0 0 0 3px rgba(255,87,35,0.15)';
              }}
              onBlur={(e) => {
                e.currentTarget.style.boxShadow = 'none';
              }}
        ...
        {glbUrl && !loading && !error && (
          <>
            <div style={{ 
              ...
              overflow: 'hidden', 
              border: `1.5px solid ${D.border}`, 
              boxShadow: '0 8px 32px rgba(255,87,35,0.12)' 
            }}>
